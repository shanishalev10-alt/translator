...
/// <reference types="node" />
/// <reference types="node" />
import { Formality, GlossaryInfo, GlossaryId, LanguageCode, NonRegionalLanguageCode, RequestParameters, StyleId, TranslateTextOptions, MultilingualGlossaryInfo, MultilingualGlossaryDictionaryEntries, StyleRuleInfo, TranslationMemoryId, TranslationMemoryInfo } from './types';
 ...
 * @private
 */
export declare function buildURLSearchParams(sourceLang: LanguageCode | null, targetLang: LanguageCode, formality: Formality | undefined, glossary: GlossaryId | GlossaryInfo | MultilingualGlossaryInfo | undefined, extraRequestParameters: RequestParameters | undefined, glossaryIds?: Array<GlossaryId | GlossaryInfo | MultilingualGlossaryInfo>): URLSearchParams;
/**
 ...
 * @private
 */
export declare function appendStyleAndTranslationMemoryOptions(data: URLSearchParams, options: {
 ...
 * @private
 */
export declare function extractTranslationMemoryId(translationMemory: TranslationMemoryId | TranslationMemoryInfo): TranslationMemoryId;
