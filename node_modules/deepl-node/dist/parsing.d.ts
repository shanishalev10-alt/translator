import { DocumentHandle, DocumentStatus, GlossaryLanguagePair, Language, TextResult, Usage, GlossaryInfo, WriteResult, MultilingualGlossaryInfo, MultilingualGlossaryDictionaryInfo, MultilingualGlossaryDictionaryEntries, MultilingualGlossaryDictionaryApiResponse, MultilingualGlossaryDictionaryEntriesApiResponse, ListMultilingualGlossaryApiResponse, StyleRuleInfo, StyleRuleInfoApiResponse, CustomInstruction, TranslationMemoryInfo, TranslationMemoryInfoApiResponse, TranslationMemoryExport, TranslationMemoryImport, TranslationMemoryJob, TranslationMemorySegments } from './types';
/**
 ...
 * @private
 */
export declare function parseTranslationMemoryInfoJson(json: string): TranslationMemoryInfo;
/**
 ...
 * @private
 */
export declare function parseTranslationMemorySegments(json: string): TranslationMemorySegments;
/**
 * Parses the given JSON string to a TranslationMemoryImport object.
 * @private
 */
export declare function parseTranslationMemoryImport(json: string): TranslationMemoryImport;
/**
 ...
 * @private
 */
export declare function parseTranslationMemoryExport(json: string, reusedExisting: boolean): TranslationMemoryExport;
/**
 * Parses the given JSON string to a TranslationMemoryJob object.
 * @private
 */
export declare function parseTranslationMemoryJob(json: string): TranslationMemoryJob;
